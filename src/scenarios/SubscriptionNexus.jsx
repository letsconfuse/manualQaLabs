...
const SubscriptionNexus = ({ addLog }) => {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto h-[800px] bg-[#0f172a] rounded-3xl overflow-hidden shadow-2xl flex font-sans border border-slate-800">
            ...
            <aside className="w-64 bg-slate-900/50 backdrop-blur-xl border-r border-slate-800 flex flex-col p-6">
                ...
                <div className="space-y-6 flex-1">
                    ...
                    <div className="pt-6 border-t border-slate-800">
                        ...
                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-bold border ${state === 'Lapsed' ? 'bg-red-500/10 text-red-400 border-red-500/20' : 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20'}`}>
            ...
            {/* 2. MAIN WORKSPACE */}
            <main className="flex-1 bg-slate-900/30 p-8 overflow-y-auto custom-scrollbar">
            ...
            {/* 3. INVOICE PREVIEW */}
            <aside className="w-80 bg-white text-slate-900 p-8 flex flex-col relative">
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="space-y-4 text-xs">
                        <div className="flex justify-between border-b pb-2 mb-4 font-bold text-slate-400 uppercase tracking-wider text-[10px]">
                            <span>Item</span>
                            <span>Cost</span>
                        </div>
                        ...
                        {/* Summary Block */}
                        <div className="border-t-2 border-slate-900 pt-4 mt-8 space-y-2">
